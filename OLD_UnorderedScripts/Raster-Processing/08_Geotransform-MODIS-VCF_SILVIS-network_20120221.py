...
VCF = "E:\\kirkdata\\mbaumann\\Landsat_Processing\\MODIS-VCF\\MOD44B_C4_TREE.2005.MOSAIC.tif"
...
# (0-B) Define composite as reference for coordinate-system
	if file.find("composite") >= 0 and file.find (".hdr") < 0:
...
output = output_folder + center_PathRow + "_MODIS-VCF" + "_" + Year + "-extent"
