...
print("")
PathRow = sys.argv[1]
output_folder = "E:\\tempdata\\Landsat\\Carlos_Composite\\Training_data\\"
source_folder = "E:\\tempdata\\Landsat\\Carlos_Composite\\" + PathRow + "\\Composites\\"
MODIS_VCF = "E:\\tempdata\\Landsat\\Carlos_Composite\\Training_data\\MODIS-VCF"
bands = [1,2,3,4,5,6]
# ##### READY TO GO #####
...
# (3-B) Initialize moving window --> moving Window-size is 20x20 Pixel
	windowsize = 50
