...
print("")
PathRow = sys.argv[1]
clip_output = "E:\\tempdata\\Landsat\\Carlos_Composite\\" + PathRow + "\\"
ledaps_folder = "E:\\tempdata\\Landsat\\Carlos_Composite\\LEDAPS\\" + PathRow + "\\"
cloud_folder = "E:\\tempdata\\Landsat\\Carlos_Composite\\Clouds\\" + PathRow + "\\Fmask_1_6_3_LEDAPS\\10pix\\"
# ##### READY TO GO #####

# ##### START THE ANALYSIS #####
print("Cropping LEDAPS-Surface-reflectance-files to extent from overlap area")
coord_txt = clip_output + "Active-area_Coordinates.txt"									# GETTING COORDINATES FROM THE TXT-FILE THAT HAS BEEN GENERATED IN THE SCRIPT BEFORE
...
for file in inputList[:]:
	if file.find(".hdr") < 0:
		...
		AA_test = output_clip = clip_output + file + "_AA"
...
print("")
AA_mask = clip_output + "Active-Area_Binary-mask"
bands = [1,2,3,4,5,6]
inputList = os.listdir(clip_output)
for file in inputList[:]:
	if file.find(".hdr") < 0 and file.find("Active-Area") < 0:
