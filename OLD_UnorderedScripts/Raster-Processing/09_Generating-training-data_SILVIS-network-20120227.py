...
bands = [1,2,3,4,5,6]
MODIS_VCF = "E:\\kirkdata\\mbaumann\\Landsat_Processing\\Landsat\\" + center_PathRow + "\\" + center_PathRow + "_MODIS-VCF" + "_" + Year + "-extent"
# ##### READY TO GO #####

# (0) Define the files we are going to process
image = root_Folder + center_PathRow + "_" + Year + "_composite"
ForestSamples = root_Folder + center_PathRow + "_" + Year + "_ForestSamples"
waterMask = root_Folder + center_PathRow + "_" + Year + "_waterMask"
ForestnessIndex = root_Folder + center_PathRow + "_" + Year + "_ForestnessIndex"
ForestNonForestSamples = root_Folder + center_PathRow + "_" + Year + "_ForestNonForestSamples"
TrainingData = root_Folder + center_PathRow + "_" + Year + "_training-data"
WaterIndex = root_Folder + center_PathRow + "_" + Year + "_NDWI"
