...
Year = sys.argv[2]
out_Folder = "E:\\kirkdata\\mbaumann\\Landsat_Processing\\Landsat\\" + center_PathRow + "\\" + Year + "\\"
root_Folder = "E:\\kirkdata\\mbaumann\\Landsat_Processing\\Landsat\\" + center_PathRow + "\\" + Year + "\\" + center_PathRow + "\\"
# ##### READY TO GO #####
...
print("--------------------------------------------------------")
print("Center-Footprint:", center_PathRow, "Year:", Year)

# (3) Get corner coordinates from MTL-File in each archive	
# Define output-file
coord_file = out_Folder + center_PathRow + "_" + Year + "_Corner-Coordinates.txt"
