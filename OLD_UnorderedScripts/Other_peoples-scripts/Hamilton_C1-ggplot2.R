...
### Create plot layout
#png("Regional_change_bar_plots.png",width=4000,height=5000,res=600)
...
table_2001 = dat_2001_FR[BAU_2001_FR]
table_2001
...
plot1 = ggplot(table_2001, aes(factor(table_2001$Region), Values, fill=Region)) + geom_bar(position="dodge") + 
scale_y_continuous(limits = c(-3,14), breaks = seq(-2,14,2)) +
labs(x = " ", y = "Area (million ha)") + scale_fill_manual(values = c("#404DAD","#A82E36","#ABCD66","#704489","#00ABBA","#F08F36","#9EAAD7")) +  
...
emptyText = textGrob(" ")
text2001  = textGrob("2001", gp = gpar(fontface = "bold", fontsize = 16))
textBAU = textGrob("BAU", gp = gpar(fontface = "bold", fontsize = 16))
textPNH = textGrob("PNH", gp = gpar(fontface = "bold", fontsize = 16))
textRUG = textGrob("RUG", gp = gpar(fontface = "bold", fontsize = 16))
textFR = textGrob("Forest & Range", rot = 90, gp = gpar(fontface = "bold", fontsize = 16))
textCP = textGrob("Crop & Pasture", rot = 90, gp = gpar(fontface = "bold", fontsize = 16))
textU = textGrob("Urban", rot = 90, gp = gpar(fontface = "bold", fontsize = 16))
