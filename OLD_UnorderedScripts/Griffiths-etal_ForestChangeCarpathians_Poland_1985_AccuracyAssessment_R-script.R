...
# REMOVE THE 'M*-CLASS
table = subset(table, Plot_Char != "M*")
...
# CREATE CLASS FOR CLASSIFICATION RESULTS
table$Class = "EMPTY"
...
write.table(table, file = "X:/mbaumann/Griffiths-etal_ForestChange-Carpathians_AccuracyAssessment/DataProcessing/Poland_1985_AccuracyAssessment_Output_revision.txt", sep = ",")