...
write.table(table, file = "X:/mbaumann/Griffiths-etal_ForestChange-Carpathians_AccuracyAssessment/DataProcessing/Poland_2010_AccuracyAssessment_Output_revision.txt", sep = ",")