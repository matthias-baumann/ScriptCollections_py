...
# ####################################### GLOBAL FUNCTIONS #################################################### #
    def Ctrans_MEM(inband_MEM, file_t_srs):
        ...
        return out_MEM
    # ####################################### GLOBAL PATHS ######################################################## #
    out_root = "G:/CHACO/ReprojectedScenes/Landsat457/"
    ref_raster = "G:/CHACO/ReprojectedScenes/Landsat457/224_079/LE72240792000028AGS00/224079_000128_Chaco_SR.bsq"
    # ####################################### START PROCESSING #################################################### #
    ...
    if GCPtrue == 0:
        ...
        prefix = out_folder + PR + "_" + date_short + "_Chaco_SR"
        # Copy GCP, MTL
