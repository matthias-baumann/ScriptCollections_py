...
# ####################################### GLOBAL PATHS ######################################################## #
    in_root = "G:/CHACO/L8_RAW/"
    out_root = "G:/CHACO/ReprojectedScenes/Landsat8/"
    raster_for_projection = "G:/CHACO/ReprojectedScenes/Landsat457/224_079/LE72240792000028AGS00/224079_000128_Chaco_SR.bsq"
# ####################################### START PROCESSING #################################################### #
    item = scenes
    ...
    fileNameRoot = item[3:9] + "_" + acq_date[2:4] + acq_date[5:7] + acq_date[8:10] + "_CHACO_SR"
    ...
    #CompressENVI(stack_out_name)
    CompressENVI(aa_out_name)
    CompressENVI(cloud_out_name)
    CompressENVI(clouddist_out_name)
    CompressENVI(nadirdist_out_name)
    CompressENVI(tirs_out_name)
