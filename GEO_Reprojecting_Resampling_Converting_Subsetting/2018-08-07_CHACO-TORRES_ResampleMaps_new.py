...
bt.baumiRT.CopyMEMtoDisk(perForest, (outputFolder + "1985_PercForest_1km.tif"))
print("Cropland")
perCropland = Aggregate(reclassRaster, 33, 2)
bt.baumiRT.CopyMEMtoDisk(perCropland, (outputFolder + "1985_PercCropland_1km.tif"))
print("Pasture")
perPasture = Aggregate(reclassRaster, 33, 3)
bt.baumiRT.CopyMEMtoDisk(perPasture, (outputFolder + "1985_PercPasture_1km.tif"))
print("Create Classification Map")
classMap = FindMax(perForest,perCropland,perPasture)
bt.baumiRT.CopyMEMtoDisk(classMap, (outputFolder + "1985_LandCover_1km.tif"))
print("")
...
print("Forest")
perForest = Aggregate(reclassRaster, 33, 1)
bt.baumiRT.CopyMEMtoDisk(perForest, (outputFolder + "2000_PercForest_1km.tif"))
print("Cropland")
perCropland = Aggregate(reclassRaster, 33, 2)
bt.baumiRT.CopyMEMtoDisk(perCropland, (outputFolder + "2000_PercCropland_1km.tif"))
print("Pasture")
perPasture = Aggregate(reclassRaster, 33, 3)
bt.baumiRT.CopyMEMtoDisk(perPasture, (outputFolder + "2000_PercPasture_1km.tif"))
print("Create Classification Map")
classMap = FindMax(perForest,perCropland,perPasture)
bt.baumiRT.CopyMEMtoDisk(classMap, (outputFolder + "2000_LandCover_1km.tif"))
print("")
...
print("Forest")
perForest = Aggregate(reclassRaster, 33, 1)
bt.baumiRT.CopyMEMtoDisk(perForest, (outputFolder + "2015_PercForest_1km.tif"))
print("Cropland")
perCropland = Aggregate(reclassRaster, 33, 2)
bt.baumiRT.CopyMEMtoDisk(perCropland, (outputFolder + "2015_PercCropland_1km.tif"))
print("Pasture")
perPasture = Aggregate(reclassRaster, 33, 3)
bt.baumiRT.CopyMEMtoDisk(perPasture, (outputFolder + "2015_PercPasture_1km.tif"))
print("Create Classification Map")
classMap = FindMax(perForest,perCropland,perPasture)
bt.baumiRT.CopyMEMtoDisk(classMap, (outputFolder + "2015_LandCover_1km.tif"))
