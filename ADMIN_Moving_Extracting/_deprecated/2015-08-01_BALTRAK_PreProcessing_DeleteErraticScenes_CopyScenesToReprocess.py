...
LandsatRAW = "G:/BALTRAK_NewScenes/"
# ####################################### START PROCESSING #################################################### #
# (1) DELETE ERATIC SCENES
# Build list
errorTXT = "X:/Baltrak/01_PreProcessing/01_Reports/ReOrder_FileCheck_v04_delete.txt"
deleteList = []
...
reprocessTXT = "X:/Baltrak/01_PreProcessing/01_Reports/ReOrder_FileCheck_v04_reprocess.txt"
# Build List
copyList = []
