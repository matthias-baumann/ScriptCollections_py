...
rootFolder = "P:/"
eco_shp = bt.baumiVT.CopyToMem(rootFolder + "data/Olson-Ramankutty_Intersection_SinglePart/WWF_potentialVeg_intersect_single_test2.shp")
#eco_shp = ogr.Open(rootFolder + "data/Olson-Ramankutty_Intersection_SinglePart/WWF_potentialVeg_intersect_single.shp")
out_csv = rootFolder + "data/results/areaSummaries_ALL_20190122.csv"
...
outDS = [["UID", "ECO_ID", "ECO_Name", "Navin_Name", "BIOME", "Prop_in_Navin",
          ...
          "FL2014_km", "FL2015_km", "FL2016_km", "FL2017_km", "Gain0017_km"]]
...
# Get needed properties from the SHP-File, the take geometry, and transform to Target-EPSG
    ...
    vals = [UID, ecoID, ecoName, navinName, biome, prop]
