...
shape = drvMemV.CopyDataSource(ogr.Open(
    "D:/Matthias/Projects-and-Publications/Publications/Publications-in-preparation/Marinaro-etal_LCLUC-Chaco-Indigenous-Communities/PI_NSalta_MG.shp"),'')
...
# ############################################################################################################# #
outFile = "D:/Matthias/Projects-and-Publications/Publications/Publications-in-preparation/Marinaro-etal_LCLUC-Chaco-Indigenous-Communities/PI_NSalta_MG_Summary.csv"
# ############################################################################################################# #
outList = []
header = ["ID", "PolygonArea_km", "F-F-F_km2", "C-C-C_km2", "P-P-P_km2", "F-C-C_km2", "F-P-P_km2", "F-F-C_km2", "F-F-P_km2", "F-P-C_km2", "Fs-Fs-Fs_km2", "P-C-C_km2", "P-P-C_km2"]
